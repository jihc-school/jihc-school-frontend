        ...
        <div className="flex flex-col md:flex-row items-center gap-12 bg-base-100">
          ...
          >
            <div className="relative group">
              ...
              {/* Actual Image */}
              <img
                src="https://i.ibb.co.com/1GR3LQzH/principal.jpg"
                alt="Principal of Novus Horizon School"
                className="relative rounded-[2.5rem] shadow-2xl w-full h-100 sm:h-130 md:h-190 object-cover"
              />
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative">
              <span className="absolute -top-6 -left-4 text-7xl text-primary/10 font-serif leading-none">
                “
              </span>
              <p className="text-base-content/80 text-lg leading-relaxed italic border-l-4 border-primary pl-6 py-2">
                Welcome to{" "}
                <span className="text-primary font-bold">
                  Novus Horizon School
                </span>
                , where we believe that every child is unique and has the
                potential to achieve greatness. Our mission is to nurture not
                just academic excellence, but also character, creativity, and
                compassion.
              </p>
              <p className="text-base-content/80 text-lg leading-relaxed mt-4">
                With state-of-the-art facilities, dedicated teachers, and a
                curriculum designed for holistic development, we prepare our
